  ...
  <div class="container">
    ...
    <div id="sidebar">
      <div id="sidebar-base">
        <div id="sidebar-top">
          <div>
            <button id="AccountView"></button>
          </div>
          <div id="sidebar-actions">
            <div>
              <button class="actionBtn" @click="openConfirm">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="50px" height="50px" fill-rule="evenodd">
