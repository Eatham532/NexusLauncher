...
import NOptionSelect from "./components/common/NOptionSelect.vue";
import NotificationMenu from "./components/other/NotificationMenu.vue";
import InstanceViewer from "./components/instance_management/InstanceViewer.vue";
import {getVersions, PistonMetadata} from "./scripts/rust/instances.ts";
...
console.log("Finished getting time. Elapsed time: " + elapsed + "ms");
        ...
        <div id="sidebar-top">
          ...
          <div id="sidebar-actions">
            ...
            <sidebar-button class="sidebarBtn" tabindex="0">
              <svg width="30px" height="30px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 72">
...
<!--        <NButton class="action-btn"><img src="https://www.htmlcssbuttongenerator.com/iconExample-search-thin.svg"></NButton>
        ...
        <NChip>Hello</NChip>
        <NChip>Hello</NChip>
        <NOptionSelect :items="['one', 'two', 'three']"></NOptionSelect>
      </div>
