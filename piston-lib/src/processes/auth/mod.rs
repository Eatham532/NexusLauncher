...
use oauth2::{AuthType, AuthUrl, AuthorizationCode, ClientId, CsrfToken, PkceCodeChallenge, RedirectUrl, Scope, TokenResponse, TokenUrl, DeviceAuthorizationUrl, StandardRevocableToken, RequestTokenError};
...
pub async fn get_auth_client(client_id: &str) -> BasicClient {
    BasicClient::new(
